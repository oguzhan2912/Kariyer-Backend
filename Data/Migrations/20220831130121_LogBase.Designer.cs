...
namespace Data.Migrations
{
    ...
    [Migration("20220831130121_LogBase")]
    partial class LogBase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.DbModel.BaseCard", b =>
                {
            ...
            modelBuilder.Entity("Data.DbModel.CVInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("CV")
                        .HasForeignKey("Data.DbModel.CVInfo", "BaseId");

                    b.HasOne("Data.DbModel.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.DbModel.ContactInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("Contact")
                        .HasForeignKey("Data.DbModel.ContactInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.EducationDegreeInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("EducationDegree")
                        .HasForeignKey("Data.DbModel.EducationDegreeInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.EducationInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("Education")
                        .HasForeignKey("Data.DbModel.EducationInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.EducationPostDegreeInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("EducationPostDegree")
                        .HasForeignKey("Data.DbModel.EducationPostDegreeInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.GeneralInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("General")
                        .HasForeignKey("Data.DbModel.GeneralInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.LanguageInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("Language")
                        .HasForeignKey("Data.DbModel.LanguageInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.OtherInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("Other")
                        .HasForeignKey("Data.DbModel.OtherInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.PostWorkInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("PostWork")
                        .HasForeignKey("Data.DbModel.PostWorkInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.ReferanceInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("Referance")
                        .HasForeignKey("Data.DbModel.ReferanceInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.SkillInfo", b =>
                {
                    b.HasOne("Data.DbModel.BaseCard", "Base")
                        .WithOne("Skill")
                        .HasForeignKey("Data.DbModel.SkillInfo", "BaseId");
            ...
            modelBuilder.Entity("Data.DbModel.BaseCard", b =>
                {
                    ...
                    b.Navigation("EducationPostDegree");
